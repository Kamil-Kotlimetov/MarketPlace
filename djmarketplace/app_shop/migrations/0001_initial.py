# Generated by Django 4.0 on 2024-01-20 17:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_flag', models.CharField(choices=[('p', 'Оплаче'), ('n', 'Не оплачен')], default='n', max_length=1, verbose_name='статус оплаты')),
