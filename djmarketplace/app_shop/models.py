...
class Profile(models.Model): #1
    """Расширенная модель ползователя"""
    ...
    status_flag = models.CharField(choices=status_choices, max_length=3, default='new', verbose_name='статус пользователя')
...
class GoodCategory(models.Model): #4
...
class Good(models.Model): #6
    name = models.CharField(max_length=25, db_index=True, verbose_name='название товара')
    category = models.ForeignKey(GoodCategory, on_delete=models.CASCADE, verbose_name='категория', null=True) #внешний ключ
...
class GoodCart(models.Model): #7
    user = models.ForeignKey(User, verbose_name='пользователь', on_delete=models.CASCADE)
    good = models.ForeignKey(Good, verbose_name='товар', on_delete=models.CASCADE)
    good_num = models.PositiveIntegerField(default=1, verbose_name='кол-во товаров')
    payment_choices = [
        ('p', 'Оплаче'),
        ('n', 'Не оплачен')
    ]
